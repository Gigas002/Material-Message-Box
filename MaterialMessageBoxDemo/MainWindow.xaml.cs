...
namespace MaterialMessageBoxDemo
{
    ...
    public partial class MainWindow
    {
        ...
        private void ShowSimpleMessageBox_OnClick(object sender, RoutedEventArgs e) => MaterialMessageBox.Show(
        ...
        {
            MessageBoxResult result = MaterialMessageBox.ShowWithCancel(
                $"This is a simple message with a cancel button. You can listen to the return value",
                "Message Box Title");
        ...
        private void ShowSimpleRTLMessageBox_OnClick(object sender, RoutedEventArgs e) => MaterialMessageBox.Show(
            $"This is a simple message{Environment.NewLine}هذه رسالة بسيطة{Environment.NewLine}{Environment.NewLine}Is'nt it cool\n.\n.\nYou could even scroll!!!\nd\no\no\no\no\no\nw\nn",
            "Message Box Title", true);
    }
}
